...
class SizeConfig {
  ...
  void init(BoxConstraints constraints, Orientation orientation) {
    if (orientation == Orientation.portrait) {
      ...
      screenWidth = constraints.maxWidth > 411.4? constraints.maxWidth/411.4 : textFactor;
      screenHeight = constraints.maxHeight > 684.4? constraints.maxHeight/684.4 : textFactor;
      isPortrait = true;
    }
    // } else {
    //   w = 684.4/100;
